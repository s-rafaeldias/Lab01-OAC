...
.data
	...
	cls: 
		.asciiz "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n" # espa�ammento para parecer novo menu apos escolha do usuario
	textMenuError:
		.asciiz "\nOp��o escolhida inv�lida, aperta '1' para continuar\n"
...
#######################################################################
	menu:
	la $a0, cls   # carregar o espa�amento
	li $v0, 4     # print do espa�amento
	syscall
